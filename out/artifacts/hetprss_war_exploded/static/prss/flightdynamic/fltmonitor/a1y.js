var createFltmonitor = function (dataObj){
	var nodeTextArray=['起飞','落地','挡轮档','客梯车靠接','开客舱门','下客完成','清洁完成','登机开始','登机结束','关客舱门','客梯车撤离','撤轮档','起飞'];
...
//        	 status:nodeStatusArray[k] ,
	...
	options.otherNodes = [
	                      ...
	                      {keyId:'otherNode_7',id:'node_in_18',nodeText:'进港摆渡车完成',outText:'',nodeBeginX:beginX+4*step+20,nodeBeginY:beginY+topOtherNodePositionY-80,width:200},
	                      {keyId:'otherNode_8',id:'node_in_19',nodeText:'出港摆渡车完成',outText:'',nodeBeginX:beginX+7.5*step,nodeBeginY:beginY+topOtherNodePositionY-80,width:200}
                      ]
	// 画线
	options.lines = [
	                 	//左竖线
	                 	...
	                 	//上侧左侧线
	                 	{x1:beginX+step*2.5,y1:beginY,x2:beginX+step*2.5,y2:beginY+topOtherNodePositionY-60},
	                 	//上侧右侧线
	                 	{x1:beginX+step*11.5,y1:beginY,x2:beginX+step*11.5,y2:beginY+topOtherNodePositionY-60}
	                 ]
	// 箭头线
	options.arrowLine = [
	                     	//下左侧带箭头的横线
	                     	...
	                     	{x1:beginX+step*2.5,y1:beginY+topOtherNodePositionY-60,width:185},
	                     	{x1:beginX+6*step,y1:beginY+topOtherNodePositionY-60,width:160},
	                     	{x1:beginX+9.5*step-20,y1:beginY+topOtherNodePositionY-60,width:240}
	...
	options.timeNodes = [
	                     ...
	                     {keyId:'mainNode_12',aTime:'',eTime:'',nodeBeginX:beginX+70+step*11,nodeBeginY:beginY-40,width:80,isText:true},
	                      ...
	                      {keyId:'otherNode_7',aTime:'',eTime:'',nodeBeginX:beginX+90+step*2.5,nodeBeginY:beginY+topOtherNodePositionY-100},
	                      {keyId:'otherNode_8',aTime:'',eTime:'',nodeBeginX:beginX+90+step*6,nodeBeginY:beginY+topOtherNodePositionY-100}
                      ]
