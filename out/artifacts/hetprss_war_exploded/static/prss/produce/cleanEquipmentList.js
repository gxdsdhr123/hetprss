		...
		if(clickRowId==null || clickRowId==''){
			...
			var id = clickRowId;
				iframe = layer.open({
					...
					area:['100%','100%'],
					closeBtn : false,
					content : ctx + "/clean/equipment/form?id=" + id + "&typeId=" + typeId,
					btn : [ "保存", "取消" ],
...
//					return index+1;
			...
			{field: "TYPE_NAME", title: "车辆类型",editable:false,align:'left',halign:'center'},
			...
			{field: "SC_PESON", title: "随车",editable:false,align:'left',halign:'center'}
	    ]
	};
