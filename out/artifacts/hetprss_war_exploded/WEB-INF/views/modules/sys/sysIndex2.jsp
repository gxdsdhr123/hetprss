	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right"><%--
					...
					<li id="themeSwitch" class="dropdown" style="display: none">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	           <%--  Copyright &copy; 2016-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="https://github.com/thinkgem/jeesite" target="_blank">JeeSite</a> ${fns:getConfig('version')}--%>
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
