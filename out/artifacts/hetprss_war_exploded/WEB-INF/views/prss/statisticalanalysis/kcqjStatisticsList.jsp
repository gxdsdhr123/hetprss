...
<body>
	<div id="container" style="padding-top:30px">
		<form  id="listForm"  action="${ctx}/kcqj/statistics/exportExcel" method="post">
	...
	<script type="text/javascript" src="${ctxStatic}/prss/statisticalanalysis/kcqjStatisticsList.js"></script>
</body>
</html>