...
<script type="text/javascript" src="${ctxStatic}/jquery/plugins/SJgantt/SJgantt-qccz.js"></script>
<body>
	...
	<div id="stopMenu">
		<button id="stop" type="button" class="btn">停用</button><br>
		<button id="member" type="button" class="btn">成员</button>
	</div>
...
<!-- 			<button type="button" class="btn btn-primary btn-sm" onclick="showLeader()">换组</button> -->
		</div>
	...
	<script type="text/javascript"
		src="${ctxStatic}/prss/scheduling/schedulingQCCZGantt.js"></script>
</body>
</html>