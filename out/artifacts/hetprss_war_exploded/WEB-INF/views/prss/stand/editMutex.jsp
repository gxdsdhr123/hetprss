...
<script type="text/javascript" src="${ctxStatic}/prss/stand/editMutex.js"></script>
</head>
<body >
	<form id="aptitudeForm" action="" class="layui-form">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<select name="ACTSTAND_CODE1" id="ACTSTAND_CODE1">
						<option value=""></option>
						<c:forEach var="actStand" items="${ACTSTAND}" >
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" class="layui-input" name="TIME_MIN" id="TIME_MIN" value="${data.TIME_MIN}" >
					<input type="hidden" class="layui-input" name="ID" id="ID" value="${data.ID}" >
					<input type="hidden" class="layui-input" name="code1" id="code1" value="${data.ACTSTAND_CODE1}" >
					<input type="hidden" class="layui-input" name="type1" id="type1" value="${data.AIRCRAFT_TYPE1}" >
					<input type="hidden" class="layui-input" name="code2" id="code2" value="${data.ACTSTAND_CODE2}" >
					<input type="hidden" class="layui-input" name="type2" id="type2" value="${data.AIRCRAFT_TYPE2}" >
				</div>
			</div>
		</div>
