...
<script type="text/javascript"
	src="${ctxStatic}/prss/produce/billAirList.js"></script>
<script type="text/javascript"
...
<body>
	...
	<form id="printWord" action="${ctx}/produce/air/exportWord" method="post" style="display: none">
			<input type="hidden" id="id" name="id"/>
	</form>
	<form id="printExcel" class="layui-form" action="${ctx}/produce/air/exportExcel" method="post" style="display: none">
