...
<script type="text/javascript" src="${ctxStatic}/prss/produce/chargeBillAdd.js"></script>
<script type="text/javascript" src="${ctxStatic}/My97DatePicker/WdatePicker.js"></script>
</head>
<body>
	<form:form id="billForm" action="${ctx}/produce/chargeBill/doAdd?billId=${billId}&flag=${flag}"
	...
	<form:input type="hidden" path="aircraftNumber"></form:input>
		...
		<div class="layui-inline"  style="margin-right: 13%;display: none;" id="serialDiv" >
		...
		<div class="layui-form-item" style="margin-left: 0px;">
			...
			<div class="layui-inline" style="padding-left: 0px;">
				...
				<div class="layui-input-inline">
					 <form:input type="text"  onclick="WdatePicker({dateFmt:'yyyyMMdd',maxDate:'%y-%M-%d'});"
						placeholder="请选择航班日期" autocomplete="off" class="layui-input"
						path="flightDate" onClick="dateFilter()"  onblur="doQuery()" />
				</div>
					
				<label class="layui-form-label" style="width: 100px;">航班号：</label>
				<div class="layui-input-inline">
					 <form:input type="text" onblur="doQuery()"
				...
				<div class="layui-input-inline" onblur="doQuery()">
				...
				<label class="layui-form-label" style="width: 100px;display: none" id ="showLab">机 位：</label>
				<div class="layui-input-inline" >
					 <form:input type="text"  readonly="true"
						placeholder="" autocomplete="off" class="layui-input"
						path="actstandCode" style="width: 186px;display: none;" ></form:input>
				</div>
			</div>	
			<div class="layui-inline" style="padding-left: 0px;display:none;" id="showDiv" >				
				...
				<div class="layui-input-inline">
					<input type="text" 
						placeholder="" autocomplete="off" class="layui-input"
						name="sta" id="sta" value="" contentEditable="false" readonly="readonly" >
				</div>
	...
	<div class="layui-inline" style="padding-left: 5%;">
				...
				<div class="layui-input-inline">
					 <form:input type="text" 
						placeholder="" autocomplete="off" class="layui-input"
						path="operator" value="" contentEditable="false" ></form:input>
				</div>	
				<label class="layui-form-label" style="width: 200px;">站坪部主管或领班:</label>
				<div class="layui-input-inline">
					 <form:input type="text" 
						placeholder="" autocomplete="off" class="layui-input"
						path = "scheduler" value="" contentEditable="false"  ></form:input>
				</div>
				<label class="layui-form-label" style="width: 100px;">岗 位：</label>
				<div class="layui-input-inline" >
					<form:input type="text" 
						placeholder="" autocomplete="off" class="layui-input"
						path="post" value="" contentEditable="false" ></form:input>
				</div>
			</div>
	</div>
	</div>	
