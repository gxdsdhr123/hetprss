...
<script type="text/javascript"
	src="${ctxStatic}/prss/produce/billTcChargeList.js"></script>
	<script type="text/javascript"
...
<body>
	...
	<form id="printWord" action="${ctx}/produce/tcCharge/exportWord" method="post" style="display: none">
			<input type="hidden" id="id" name="id"/>
			<input type="hidden" id="type" name="type"/>
	</form>
	<form id="printExcel" class="layui-form" action="${ctx}/produce/tcCharge/exportExcel" method="post" style="display: none">
