...
<html>
<head>
<title>清水加注规则设置</title>
<meta name="decorator" content="default" />
<%@ include file="/WEB-INF/views/include/bootstrap.jsp"%>
<%@include file="/WEB-INF/views/include/edittable.jsp"%>
<%@include file="/WEB-INF/views/prss/flightdynamic/flightDynFilter.jsp"%>
<%-- <link href="${ctxStatic}/prss/rule/css/taskAllotRuleList.css" rel="stylesheet" /> --%>
<body>
	<div id="container">
	...
	<script type="text/javascript" src="${ctxStatic}/prss/rule/waterfill/waterFillRuleList.js"></script>
</body>
</html>