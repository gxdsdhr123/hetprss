...
<body>
	<form class="layui-form" action="" id="createForm">
		...
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<select id="ruleExtInOutPort" name="ruleExtInOutPort">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<select class="form-control select2 airplaneType" data-type="airplaneType"
						...
						<c:forEach items="${atcactypeListMap.left}" var="actype">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<select class="form-control select2 airline" name="airline" data-type="airline"
						...
						<c:forEach items="${airlineListMap.left}" var="airline">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline" style="width: 600px;">
						<input id="expression" name="expression" type="hidden"
							value="${ruleInfo.drlStr}"> <input id="drools"
							name="drools" type="hidden"> <input id="colids"
							name="colids" type="hidden" value="${ruleInfo.colids}">
	...
	<div class="rows">
				...
				<c:forEach items="${fns:getCurrentJobKind()}" var="jobKind" >
					<c:forEach items="${jobKind.typeList}" var="jobType" varStatus="status">
						<tr>
							...
							<td>
								<a href="javascript:void(0)" style="color:#3c8dbc;" 
							...
							<td>
								<button id="${jobType.typeCode }SaveBtn" name="saveBtn" class="fa fa-floppy-o saveBtn" aria-hidden="true" disabled
									title="点击保存" style="font-size:18px;cursor:pointer" onclick="saveCache('${jobType.typeCode }')"></button>  
							</td>
						</tr>
					</c:forEach>
				</c:forEach>
		...
		<div class="col-md-8">
			<table class="layui-table" id="jobTypeTable">
				<thead>
					<tr>
						<td>
							序号
