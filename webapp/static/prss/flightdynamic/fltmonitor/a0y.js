var createFltmonitor = function (dataObj){
	var nodeTextArray=['起飞','落地','挡轮档','客梯车靠接','开客舱门','下客完成','清洁完成','客梯车撤离','结束'];
...
//	var nodeStatusArray=[];
	...
	options.otherNodes = [
	                      ...
	                      {keyId:'otherNode_7',id:'node_in_18',nodeText:'进港摆渡车完成',outText:'',nodeBeginX:beginX+5*step,nodeBeginY:beginY+topOtherNodePositionY-80,width:200}
                      ]
	// 画线
	options.lines = [
	                 	//左竖线
	...
	options.arrowLine = [
	                     	...
	                     	{x1:beginX+step*2.5,y1:beginY+topOtherNodePositionY-60,width:350},
	                     	{x1:beginX+step*6.5-10,y1:beginY+topOtherNodePositionY-60,width:290}
	                     ]
	...
	options.timeNodes = [
	                     ...
	                     {keyId:'mainNode_8',aTime:'',eTime:'',nodeBeginX:beginX+90+step*7,nodeBeginY:beginY-40},
	                      ...
	                      {keyId:'otherNode_7',aTime:'',eTime:'',nodeBeginX:beginX+90+step*3,nodeBeginY:beginY+topOtherNodePositionY-100}
                      ]
