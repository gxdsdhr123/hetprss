...
<div id="flight-inout" class="container" style="display:none;padding-top:10px;">
	...
	<div class="row">
		<div class="col-sm-6">进港行李件数：<span data-id="aaa"></span></div>
		<div class="col-sm-6">进港货邮重量：<span data-id="bbb"></span></div>
	</div>
	<div class="row">
		<div class="col-sm-6">出港行李件数：<span data-id="ccc"></span></div>
		<div class="col-sm-6">出港货邮重量：<span data-id="ddd"></span></div>
	</div>
	<div class="row">
