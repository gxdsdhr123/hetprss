...
<script type="text/javascript" src="${ctxStatic}/prss/produce/billInPickList.js"></script>
...
<body>
	...
	<form id="printWord" action="${ctx}/produce/inPick/exportWord" method="post" style="display: none">
			<input type="hidden" id="id" name="id"/>
	</form>
	<form id="printExcel" class="layui-form" action="${ctx}/produce/inPick/exportExcel" method="post" style="display: none">
