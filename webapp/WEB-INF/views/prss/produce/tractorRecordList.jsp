...
<body>
	<div id="container">
		...
		<form id="printForm" action="${ctx}/produce/tractor/print" method="post" style="display: none">
	...
	<script type="text/javascript" src="${ctxStatic}/prss/produce/tractorRecordList.js"></script>
</body>
</html>