...
<body>
    ...
    <div id="myTabContent" class="tab-content">
      <div role="tabpanel" class="tab-pane fade active in" id="fltsingle" aria-labelledby="fltsingle-tab">
        <iframe  src="${ctx}/flightDynamic/listSingleGantt?inFltid=${inFltid }&outFltid=${outFltid}" style="overflow:auto;" frameborder="no" width="100%" height="100%"></iframe>
      </div>
      <div role="tabpanel" class="tab-pane fade" id="fltmonitor" aria-labelledby="fltmonitor-tab">
      	<iframe  src="${ctx }/fltmonitor/fltmonitorList?inFltid=${inFltid }&outFltid=${outFltid}" style="overflow:auto;" frameborder="no" width="100%" height="100%"></iframe>
      </div>
     </div>
