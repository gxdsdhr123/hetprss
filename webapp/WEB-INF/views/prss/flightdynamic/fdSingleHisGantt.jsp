...
<script type="text/javascript" src="${ctxStatic}/jquery/plugins/SJgantt/SJgantt-fdSingleHis.js"></script>
<body>
	...
	<script type="text/javascript" src="${ctxStatic}/prss/flightdynamic/fdSingleHisGantt.js"></script>
</body>
</html>