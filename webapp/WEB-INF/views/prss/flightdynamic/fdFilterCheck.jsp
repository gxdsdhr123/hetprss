...
<script type="text/javascript" src="${ctxStatic}/prss/flightdynamic/fdFilterCheck.js"></script>
<script>
	var items = ${items};
</script>
</head>
				...
				<div>
					<ul class="list-group sortable down" id="allul"
						...
						<c:forEach items="${items}" var="item">
							<li class="list-group-item" id="${item.id}" onclick="liclick(this);" name="${item.selectText}"
