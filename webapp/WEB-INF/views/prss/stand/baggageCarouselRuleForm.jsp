...
<body>
	...
	<div class="row">
		...
		<div class="col-md-7">
			<div id="leftDiv4">
				<div class="layui-form-item">
					<label class="layui-form-label">可选行李转盘</label>
					<div class="layui-input-inline">
				...
				<ul class="list-group sortable unfixedUL" id="allUnfixedUL">
					<c:forEach items="${crslSelectableList}" var="gate">
			...
			<div id="rightDiv4">
				<div class="layui-form-item">
					<label class="layui-form-label">行李转盘顺序</label>
				</div>
				<ul class="list-group sortable unfixedUL chooseUnfixedFiled"
					id="selUnfixedUL">
					<c:forEach items="${crslSelectedList}" var="gate">
						<li
	...
	<script type="text/javascript" src="${ctxStatic}/prss/stand/baggageCarouselRuleForm.js"></script>
