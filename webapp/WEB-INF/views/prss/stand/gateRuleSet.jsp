...
<body>
                ...
                <div class="layui-input-inline" style="width: 90%" id="params">
                    <c:forEach items="${paramList }" var="item" step="1"
                        ...
                        <input type="button" value="${item.title }"
                            ...
                            data-en="${item.field }" data-id="${item.id }"
	...
	<div class="row">
		...
		<div class="col-md-7">
			<div id="leftDiv4">
				<div class="layui-form-item">
					<label class="layui-form-label" style="width: 100px;">可选登机口</label>
					<div class="layui-input-inline">
				...
				<ul class="list-group sortable unfixedUL" id="allUnfixedUL">
					<c:forEach items="${gateSelectableList}" var="gate">
						<li class='list-group-item hr' data-code='${gate.id};${gate.text}'>${gate.text}</li>
					</c:forEach>
				</ul>
			</div>
			<div id="middleDiv">
	...
	<script type="text/javascript" src="${ctxStatic}/prss/stand/gateRuleSet.js"></script>
