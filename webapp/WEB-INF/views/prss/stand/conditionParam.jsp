...
<body>
        ...
        <form id="filterForm" class="layui-form" onkeydown="if(event.keyCode==13){return false;}">
            <div id="leftDiv4" >
                ...
                <ul class="list-group sortable unfixedUL" id="allUnfixedUL">
	                <c:forEach items="${list }" var="item" end="199">
	                    <li class='list-group-item hr' data-code='${item.ID }'>${item.COL_CNNAME }</li>
	                </c:forEach>
                </ul>
            </div>
            <div id="middleDiv">
            ...
            <div id="rightDiv4">
                ...
                <ul class="list-group sortable unfixedUL chooseUnfixedFiled" id="selUnfixedUL">
                    <c:forEach items="${paramList }" var="item">
                        <li class='list-group-item hr ui-draggable ui-draggable-handle ui-sortable-handle' data-code='${item.ID }'>${item.COL_CNNAME }</li>
                    </c:forEach>
                </ul>
            </div>
        </form>
	...
	<script type="text/javascript" src="${ctxStatic}/prss/stand/conditionParam.js"></script>
