...
<body>
	<form class="layui-form layui-form-pane" action="">
		<div id="search" class="layui-form-item" style="padding: 10px 0 0 20px;">
			<div class="layui-inline">
				<div class="input-group" style="width:300px;">
	                <label class="input-group-addon" for="key">关键字</label>
	                <input type="text" class="empty layui-input" id="key" name="key" maxlength="50">
	             </div>
			</div>
		</div>
	</form>
