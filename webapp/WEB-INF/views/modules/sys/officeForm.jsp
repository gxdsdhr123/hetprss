	...
	<div class="box box-solid">
		...
		<div class="box-body">
			<form:form id="inputForm" modelAttribute="office"
				action="${ctx}/sys/office/save" method="post" class="layui-form">
				<form:hidden path="id" />
				...
				<div class="layui-form-item">
					...
					<span class="layui-form-mid layui-word-aux">“是”代表此账号允许登陆，“否”则表示此账号不允许登陆</span>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<form:textarea path="remarks" htmlEscape="false" rows="3"
							maxlength="200" class="layui-textarea"/>
					</div>
				</div>
				<c:if test="${empty office.id}">
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<c:forEach items="${fns:getDictList('sys_office_common')}" var="tmp">
								<input name="childDeptList" type="checkbox" title="${tmp.label}" value="${tmp.value}">
							</c:forEach>
						</div>
					</div>
				</c:if>
				<div class="layui-form-item text-center">
					<shiro:hasPermission name="sys:office:edit">
						<input id="btnSubmit" class="layui-btn layui-btn-primary" type="submit" value="保 存" />&nbsp;</shiro:hasPermission>
						<input id="btnCancel" class="layui-btn layui-btn-primary" type="button" value="返 回" onclick="redirect('${ctx}/sys/office')" />
				</div>
			</form:form>
		</div>
	</div>
