...
<script type="text/javascript">
	layui.use(["form","layer"],function(){
		var form = layui.form;
		$("#openMenuTreeBtn").click(function(){
			layer.open({
				title:"角色授权",
				type : 1,
				area : [ "400px", "450px" ],
		...
		$("#menuTree").css("position","relative");
		new PerfectScrollbar('#menuTree');
	});
...
<body>
	<div class="box box-widget">
		<div class="box-header with-border">
			<h3 class="box-title">
				角色<shiro:hasPermission name="sys:role:edit">${not empty role.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:role:edit">查看</shiro:lacksPermission>
			</h3>
		</div>
		<div class="box-body">
			<form:form id="inputForm" modelAttribute="role"
				action="${ctx}/sys/role/save" method="post" class="layui-form">
				<form:hidden path="id" />
				...
				<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<sys:treeselect id="office" name="office.id"
								...
								url="/sys/office/treeData" cssClass="required form-control" />
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						...
						<form:input path="enname" htmlEscape="false" maxlength="50"
							class="required layui-input" />
					</div>
					<span class="layui-form-mid layui-word-aux"><font color="red">*</font>工作流用户组标识</span>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<%--
							...
							<span class="layui-form-mid layui-word-aux" title="activiti有3种预定义的组类型：security-role、assignment、user 如果使用Activiti Explorer，需要security-role才能看到manage页签，需要assignment才能claim任务">
				...
				<div class="layui-form-item">
					...
					<span class="layui-form-mid layui-word-aux">“是”代表此数据只有超级管理员能进行修改，“否”则表示拥有角色修改人员的权限都能进行修改</span>
				</div>
				<div class="layui-form-item">
					...
					<span class="layui-form-mid layui-word-aux">“是”代表此数据可用，“否”则表示此数据不可用</span>
				</div>
				<div class="layui-form-item">
					...
					<span class="layui-form-mid layui-word-aux">特殊情况下，设置为“按明细设置”，可进行跨机构授权</span>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">角色授权:</label>
					<div class="layui-input-inline">
						<button type="button" id="openMenuTreeBtn" class="layui-btn layui-btn-small layui-btn-primary"><i class="fa fa-eye">&nbsp;</i>角色授权</button>
						<div id="menuTree" class="ztree" style="margin-top: 3px; float: left;display: none;height: 360px;width:100%;overflow-y:auto"></div>
				...
				<div class="layui-form-item text-center" id="toolbar">
					<c:if test="${(role.sysData eq fns:getDictValue('是', 'yes_no', '1') && fns:getUser().admin)||!(role.sysData eq fns:getDictValue('是', 'yes_no', '1'))}">
						<shiro:hasPermission name="sys:role:edit">
							<button id="btnSubmit" class="layui-btn layui-btn-primary" type="submit" >保 存</button>&nbsp;
						</shiro:hasPermission>
					</c:if>
					<button id="btnCancel" class="btn" type="button" value="返 回" onclick="redirect('${ctx}/sys/role')" >返 回</button>
				</div>
			</form:form>
		</div>
	</div>
