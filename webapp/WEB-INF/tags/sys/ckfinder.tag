...
<label id="${input}Preview" class="layui-form-label text-left" style="width:auto;"></label>
<c:if test="${!readonly}">
	<label class="layui-form-label" style="width:60px;"><a href="javascript:" onclick="${input}FinderOpen();" class="btn">${selectMultiple?'添加':'选择'}</a></label>
	<label class="layui-form-label" style="width:60px;"><a href="javascript:" onclick="${input}DelAll();" class="btn">清除</a></label>
</c:if>
