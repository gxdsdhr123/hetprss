 ...
 */
package com.neusoft.framework.modules.act.service.ext;
...
import com.neusoft.framework.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.neusoft.framework.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.neusoft.framework.modules.sys.entity.User(null, userId)))){
