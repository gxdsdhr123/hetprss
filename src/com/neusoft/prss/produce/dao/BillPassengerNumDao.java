...
@MyBatisDao
public interface BillPassengerNumDao extends BaseDao {
	
	JSONArray getDataList();
	
	List<Map<String ,String>> getDataTotal();
	...
	int saveAdd(BillPassengerNumEntity entity);
	
	int saveEdit(BillPassengerNumEntity entity);
