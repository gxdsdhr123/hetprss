 ...
 */
package com.neusoft.prss.workflow.access;
...
public class Page<T> implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8770460595501960513L;
	...
	public Page() {
		if(StringUtils.isNotBlank(Global.getConfig("page.pageSize"))){
