...
@MyBatisDao
public interface TaskMonitor5Dao {
	...
	HashMap<String, Object> getIfCarDetail(@Param(value="taskId")String taskId);

	int getIfCarHaveAptitudeOne(HashMap<String, Object> map);

	int getIfCarHaveAptitudeTwo(HashMap<String, Object> map);
}
